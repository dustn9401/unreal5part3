...
#define AB_LOG(LogCat, Verbosity, Format, ...) UE_LOG(LogCat, Verbosity, TEXT("[%s, %s, %d] %s"), LOG_NET_MODE_INFO, *FString(__FUNCTION__), __LINE__, *FString::Printf(Format, ##__VA_ARGS__))
